              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    SizedBox(
                      width: 100,
                      child: Text(getDay(data.daily[index].dt),),
                    ),
                    SizedBox(
                      height: 30,
                      width: 30,
                      child: Image.asset('assets/weather_images/${data.daily[index].weather![0].icon}.png'),
                    ),
                    Text("${data.daily[index].temp!.max!.round()}° / ${data.daily[index].temp!.min!.round()}°")
                  ],
                ),
              )
            ],
