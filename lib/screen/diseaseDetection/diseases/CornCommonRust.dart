...
class CornCommonRust extends StatefulWidget {
  ...
  const CornCommonRust({super.key, required this.title});
...
class _CornCommonRustState extends State<CornCommonRust> {
  ...
  final urlImage = [
    "https://firebasestorage.googleapis.com/v0/b/login-draft-69de1.appspot.com/o/disease_assets%2Fcorn.jpg?alt=media&token=d6eced9e-020c-4c89-af25-5e7bf145a0a3",
    "https://firebasestorage.googleapis.com/v0/b/login-draft-69de1.appspot.com/o/disease_assets%2Fcorn2.jpg?alt=media&token=6bc92e74-62c3-4fe3-ab8b-ca489bd035fe",
    "https://firebasestorage.googleapis.com/v0/b/login-draft-69de1.appspot.com/o/disease_assets%2Fcorn3.png?alt=media&token=c9e7db04-c673-4f5c-8722-52c5d6ccc2c5"
  ];
