...
class TomatoYellow extends StatefulWidget {
  ...
  const TomatoYellow({super.key, required this.title});
...
class TomatoYellowState extends State<TomatoYellow> {
  ...
  final urlImage = [
    "https://firebasestorage.googleapis.com/v0/b/login-draft-69de1.appspot.com/o/disease_assets%2Fcurl.png?alt=media&token=b87046b4-954e-4113-b670-f5d1a20eb2af",
    "https://firebasestorage.googleapis.com/v0/b/login-draft-69de1.appspot.com/o/disease_assets%2Fcurl2.jpg?alt=media&token=a375b302-6691-4f1f-a424-1a6bdcd94c3b",
    "https://firebasestorage.googleapis.com/v0/b/login-draft-69de1.appspot.com/o/disease_assets%2Fcurl3.jpg?alt=media&token=d0283047-ff71-4159-aad2-df8678882bd7"
  ];
