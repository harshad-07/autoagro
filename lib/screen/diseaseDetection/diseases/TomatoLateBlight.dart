...
class TomatoLateBlight extends StatefulWidget {
  ...
  const TomatoLateBlight({super.key, required this.title});
...
class _TomatoLateBlightState extends State<TomatoLateBlight> {
  ...
  final urlImage = [
    "https://firebasestorage.googleapis.com/v0/b/login-draft-69de1.appspot.com/o/disease_assets%2Flatetomato.jpg?alt=media&token=ffed16dc-94f5-4342-be8f-3f9be8ebb73a",
    "https://firebasestorage.googleapis.com/v0/b/login-draft-69de1.appspot.com/o/disease_assets%2Flatetomato2.jpeg?alt=media&token=e6736a12-2957-4ac2-8f1b-bd06be40a03a",
    "https://firebasestorage.googleapis.com/v0/b/login-draft-69de1.appspot.com/o/disease_assets%2Flatetomato3.jpg?alt=media&token=488ec515-e1ea-4e6d-bb7a-d7ecf4d827d2"
  ];
