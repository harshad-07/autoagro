...
class TomatoMosaic extends StatefulWidget {
  ...
  const TomatoMosaic({super.key, required this.title});
...
class TomatoMosaicState extends State<TomatoMosaic> {
  ...
  final urlImage = [
    "https://firebasestorage.googleapis.com/v0/b/login-draft-69de1.appspot.com/o/disease_assets%2Fmosaic.jpg?alt=media&token=edb73075-2ea6-48e3-9521-18d23d94ab37",
    "https://firebasestorage.googleapis.com/v0/b/login-draft-69de1.appspot.com/o/disease_assets%2Fmosaic2.jpg?alt=media&token=760b11a2-4ad0-407e-8649-73470a17d869",
    "https://firebasestorage.googleapis.com/v0/b/login-draft-69de1.appspot.com/o/disease_assets%2Fmosaic3.jpg?alt=media&token=81f420c3-8247-4eea-a847-c61f60f88f98"
  ];
