...
class TomatoLeafSpot extends StatefulWidget {
  ...
  const TomatoLeafSpot({super.key, required this.title});
...
class _TomatoLeafSpotState extends State<TomatoLeafSpot> {
  ...
  final urlImage = [
    "https://firebasestorage.googleapis.com/v0/b/login-draft-69de1.appspot.com/o/disease_assets%2Ftomatospot1.jpg?alt=media&token=0c549557-741e-415a-a0c9-b8e1338ef1a1",
    "https://firebasestorage.googleapis.com/v0/b/login-draft-69de1.appspot.com/o/disease_assets%2Ftomatospot2.jpeg?alt=media&token=886fb6a0-43c2-48bd-a889-7fe61fec3731",
    "https://firebasestorage.googleapis.com/v0/b/login-draft-69de1.appspot.com/o/disease_assets%2Ftomatospot3.jpg?alt=media&token=4a8ef267-737b-49e9-9d16-97f178fa7ba8"
  ];
