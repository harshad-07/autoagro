...
class PotatoLateBlight extends StatefulWidget {
  ...
  const PotatoLateBlight({super.key, required this.title});
...
class _PotatoLateBlightState extends State<PotatoLateBlight> {
  ...
  final urlImage = [
    "https://firebasestorage.googleapis.com/v0/b/login-draft-69de1.appspot.com/o/disease_assets%2Fplate.jpg?alt=media&token=0a377377-4f16-496f-b4fb-9c702f97f19d",
    "https://firebasestorage.googleapis.com/v0/b/login-draft-69de1.appspot.com/o/disease_assets%2Fplate2.jpg?alt=media&token=8d127acf-a553-4af5-9776-660ce74b7fb8",
    "https://firebasestorage.googleapis.com/v0/b/login-draft-69de1.appspot.com/o/disease_assets%2Fplate3.jpeg?alt=media&token=5ca96b12-b403-41d6-8499-edeb876e7cab"
  ];
