...
class PotatoEarlyBlight extends StatefulWidget {
  ...
  const PotatoEarlyBlight({super.key, required this.title});
...
class _PotatoEarlyBlightState extends State<PotatoEarlyBlight> {
  ...
  final urlImage = [
    "https://firebasestorage.googleapis.com/v0/b/login-draft-69de1.appspot.com/o/disease_assets%2F16.jpg?alt=media&token=d9243559-0259-4968-837d-8c5eec432bcb",
    "https://firebasestorage.googleapis.com/v0/b/login-draft-69de1.appspot.com/o/disease_assets%2F17.jpg?alt=media&token=5de6da8a-0268-4bf3-8e9d-df4a6acf1407",
    "https://firebasestorage.googleapis.com/v0/b/login-draft-69de1.appspot.com/o/disease_assets%2F18.jpg?alt=media&token=f3fdf0a1-a8f7-4623-a980-9ee5de29ddf3"
  ];
