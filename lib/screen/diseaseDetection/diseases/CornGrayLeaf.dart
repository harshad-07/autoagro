...
class CornGrayLeaf extends StatefulWidget {
  ...
  const CornGrayLeaf({super.key, required this.title});
...
class _CornGrayLeafState extends State<CornGrayLeaf> {
  ...
  final urlImage = [
    "https://firebasestorage.googleapis.com/v0/b/login-draft-69de1.appspot.com/o/disease_assets%2Fcorngray.jpeg?alt=media&token=d0e0531a-f193-4132-b6ca-0052105e3f80",
    "https://firebasestorage.googleapis.com/v0/b/login-draft-69de1.appspot.com/o/disease_assets%2Fcorngray2.png?alt=media&token=b3ec4081-18ce-490a-b419-243e53d56b27",
    "https://firebasestorage.googleapis.com/v0/b/login-draft-69de1.appspot.com/o/disease_assets%2Fcorngray3.png?alt=media&token=eb304be3-962c-4d9d-9acd-3dfa0b0d32f3"
  ];
