...
class NorthernCornLeafBlight extends StatefulWidget {
  ...
  const NorthernCornLeafBlight({super.key, required this.title});
...
class _NorthernCornLeafBlightState extends State<NorthernCornLeafBlight> {
  ...
  final urlImage = [
    "https://firebasestorage.googleapis.com/v0/b/login-draft-69de1.appspot.com/o/disease_assets%2Fncorn.JPG?alt=media&token=5d94a791-7ed7-48ce-a84a-48f6691276d1",
    "https://firebasestorage.googleapis.com/v0/b/login-draft-69de1.appspot.com/o/disease_assets%2Fncorn2.jpg?alt=media&token=cae734b0-1b26-4cc6-95cc-f182edf1e6e7",
    "https://firebasestorage.googleapis.com/v0/b/login-draft-69de1.appspot.com/o/disease_assets%2Fncorn3.png?alt=media&token=dd351ee6-249e-4481-b10f-2ce2ed34bf71"
  ];
