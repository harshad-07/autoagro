...
class GrapeEsca extends StatefulWidget {
  ...
  const GrapeEsca({super.key, required this.title});
...
class _GrapeEscaState extends State<GrapeEsca> {
  ...
  final urlImage = [
    "https://firebasestorage.googleapis.com/v0/b/login-draft-69de1.appspot.com/o/disease_assets%2Fesca.jpg?alt=media&token=7c7e0f40-273b-4a80-ba6f-a87d3c385c2a",
    "https://firebasestorage.googleapis.com/v0/b/login-draft-69de1.appspot.com/o/disease_assets%2Fesca2.jpg?alt=media&token=c4e02ab5-26c4-43d3-bc00-af17105fbc0f",
    "https://firebasestorage.googleapis.com/v0/b/login-draft-69de1.appspot.com/o/disease_assets%2Fesca3.jpeg?alt=media&token=a33b5a26-63b7-4400-be57-136ff40be84f"
  ];
