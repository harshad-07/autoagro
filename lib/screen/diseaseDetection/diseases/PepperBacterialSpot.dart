...
class PepperBacterialSpot extends StatefulWidget {
  ...
  const PepperBacterialSpot({super.key, required this.title});
...
class PepperBacterialSpotState extends State<PepperBacterialSpot> {
  ...
  final urlImage = [
    "https://firebasestorage.googleapis.com/v0/b/login-draft-69de1.appspot.com/o/disease_assets%2Fpepper1.jpg?alt=media&token=e6660524-24e4-4bc6-9240-d3835dd383cc",
    "https://firebasestorage.googleapis.com/v0/b/login-draft-69de1.appspot.com/o/disease_assets%2Fpepper2.png?alt=media&token=b1c3dee5-cae7-44dc-8b8b-b0584bf547f1",
    "https://firebasestorage.googleapis.com/v0/b/login-draft-69de1.appspot.com/o/disease_assets%2Fpepper3.jpg?alt=media&token=cb290932-3145-4992-8a3c-a3081bc28d35"
  ];
