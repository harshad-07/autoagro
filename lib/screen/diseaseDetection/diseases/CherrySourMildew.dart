...
class CherrySour extends StatefulWidget {
  ...
  const CherrySour({super.key, required this.title});
...
class _CherrySourState extends State<CherrySour> {
  ...
  final urlImage = [
    "https://firebasestorage.googleapis.com/v0/b/login-draft-69de1.appspot.com/o/disease_assets%2Fcherrysour.jpg?alt=media&token=904500d1-224c-440a-a672-0f83a6d1e79b",
    "https://firebasestorage.googleapis.com/v0/b/login-draft-69de1.appspot.com/o/disease_assets%2Fcherrysour2.jpg?alt=media&token=7e337736-0b71-469a-b4f5-abb286e4340f",
    "https://firebasestorage.googleapis.com/v0/b/login-draft-69de1.appspot.com/o/disease_assets%2Fcherrysour3.jpeg?alt=media&token=cb357734-9e2d-4149-aaab-674cacbd929e"
  ];
